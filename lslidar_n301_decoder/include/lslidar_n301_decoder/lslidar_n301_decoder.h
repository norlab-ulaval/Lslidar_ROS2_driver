...
#include "lslidar_n301_msgs/msg/lslidar_n301_difop.hpp"
#include "lslidar_n301_msgs/msg/lslidar_n301_point.hpp"
#include "lslidar_n301_msgs/msg/lslidar_n301_scan.hpp"
#include "lslidar_n301_msgs/msg/lslidar_n301_sweep.hpp"
...
class LslidarN301Decoder : public rclcpp::Node {
public:

    LslidarN301Decoder();
	LslidarN301Decoder(const rclcpp::NodeOptions& options);
    ...
    typedef std::shared_ptr<LslidarN301Decoder> LslidarN301DecoderPtr;
    typedef std::shared_ptr<const LslidarN301Decoder> LslidarN301DecoderConstPtr;
...
private:
    ...
    void packetCallback(const lslidar_n301_msgs::msg::LslidarN301Packet::UniquePtr msg);
	void processDifop(const lslidar_n301_msgs::msg::LslidarN301Packet::UniquePtr difop_msg);
	void TypeReceive(const std_msgs::msg::Byte::UniquePtr msg);
	...
	lslidar_n301_msgs::msg::LslidarN301Sweep::UniquePtr sweep_data;
	lslidar_n301_msgs::msg::LslidarN301Sweep::UniquePtr sweep_data1;
	lslidar_n301_msgs::msg::LslidarN301Difop::UniquePtr Difop_data;
	
	rclcpp::Subscription<lslidar_n301_msgs::msg::LslidarN301Packet>::SharedPtr packet_sub;
	rclcpp::Subscription<lslidar_n301_msgs::msg::LslidarN301Packet>::SharedPtr difop_sub_;
	rclcpp::Subscription<std_msgs::msg::Byte>::SharedPtr type_sub;
    rclcpp::Publisher<lslidar_n301_msgs::msg::LslidarN301Sweep>::SharedPtr sweep_pub;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr point_cloud_pub;
    rclcpp::Publisher<sensor_msgs::msg::LaserScan>::SharedPtr scan_pub;
	rclcpp::Publisher<lslidar_n301_msgs::msg::LslidarN301Difop>::SharedPtr device_pub;
};
