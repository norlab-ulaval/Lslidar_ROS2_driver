...
{
static const size_t packet_size = sizeof(lslidar_ch_msgs::msg::LslidarChPacket().data);
////////////////////////////////////////////////////////////////////////
...
int InputSocket::getPacket(lslidar_ch_msgs::msg::LslidarChPacket::UniquePtr& pkt,std::string pkg_name)
{
  ...
  pkt->header.stamp = rclcpp::Time(((time2 + time1) / 2.0)*1e9);
  return 0;
}
