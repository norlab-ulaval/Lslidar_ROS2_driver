...
public:
  ...
  virtual int getPacket(lslidar_ch_msgs::msg::LslidarChPacket::UniquePtr& pkt,std::string pkg_name) = 0;
...
public:
  ...
  virtual int getPacket(lslidar_ch_msgs::msg::LslidarChPacket::UniquePtr& pkt, std::string pkg_name);
